...
Vue.component('btn-ban-component', require('./components/BtnBanComponent.vue').default);
Vue.component('btn-mute-component', require('./components/BtnMuteComponent.vue').default);
